 ...
 * Тип запроса.
 */
export declare type SystemMessageName = 'CLOSE_APP' | 'MESSAGE_TO_SKILL' | 'RUN_APP' | 'SERVER_ACTION' | 'ANSWER_TO_USER' | 'ERROR' | 'NOTHING_FOUND' | 'POLICY_RUN_APP';
/**
 ...
 */
export declare type ImageAddress = Url | Local | LocalContact;
/**
 * Адрес картинки в локальном пространстве клиента https://www.figma.com/file/MQHBgPkW4dqXmI2549WioI/Dev?node-id=19%3A9
 */
export declare type LocalImageIdentificator = 'add_contactless_payment' | 'apple_wallet' | 'arrow_right_chevron_rectangle' | 'arrow_right_trace_line' | 'arrows_forward_back' | 'atm_banknote' | 'bag' | 'ballot_paper' | 'bar_graph' | 'basket' | 'beach_umbrella' | 'bell' | 'bell_crossed' | 'between_accounts' | 'boarding_pass' | 'bolt' | 'box' | 'building' | 'calculator' | 'camera' | 'candy' | 'capsule' | 'car' | 'card' | 'card_amex' | 'card_amex_black' | 'card_amex_gold' | 'card_blocked' | 'card_chevron_left' | 'card_ghost' | 'card_maestro_null' | 'card_mc' | 'card_mc_black' | 'card_mc_gold' | 'card_mc_null' | 'card_mir' | 'card_mir_black' | 'card_mir_gold' | 'card_mir_null' | 'card_momentum' | 'card_on_card' | 'card_plus' | 'card_pro100_null' | 'card_uek' | 'card_viewfinder' | 'card_visa_gold' | 'card_visa_black' | 'card_visa' | 'card_visa_infinite_sber' | 'card_visa_infinite' | 'card_visa_digital' | 'card_visa_null' | 'cards_carousel' | 'case' | 'case_diagram' | 'chess_piece' | 'circle_cross' | 'circle_plus' | 'clock' | 'coat_of_arms' | 'coin' | 'coin_heart' | 'color_spasibo' | 'color_total' | 'counterclock_wise' | 'crown' | 'digital_banknotes' | 'document' | 'document_checkmark' | 'document_magnifying_glass' | 'document_on_document' | 'drop' | 'ellipsis' | 'eye' | 'eye_crossed' | 'face' | 'face_id' | 'falling_coin' | 'file_pdf' | 'fingerprint' | 'flag' | 'flame' | 'flasher' | 'funnel' | 'gamepad' | 'gear' | 'gift' | 'globe' | 'hammer' | 'handset' | 'heart' | 'heart_hand' | 'house' | 'house_handset' | 'house_percent' | 'info' | 'key' | 'list' | 'lock_closed' | 'lock_opened' | 'magnit' | 'mail' | 'mail_eye' | 'mail_waves' | 'man_badge' | 'man_wheelchair' | 'map' | 'mask' | 'mindmap' | 'mobile' | 'mobile_plus' | 'mobile_plus_alt' | 'mobile_waves' | 'necklace' | 'note' | 'notebook_waves' | 'open_book' | 'other' | 'paper_tray' | 'parking' | 'passport' | 'paw' | 'pencil_line' | 'percent' | 'pfm' | 'photo' | 'pie_chart' | 'placeholder' | 'plane' | 'play' | 'postcard_heart' | 'pram' | 'qr_code' | 'receipt' | 'rectangle_on_dashed_rectangle' | 'rectangle_speech_bubble' | 'rectangle_speech_bubble_on_speech_bubble' | 'rectangle_watches' | 'round_speech_bubble_question' | 'round_watches' | 'ruble_dollar' | 'ruble_plus' | 'safe' | 'safe_diagram' | 'sber' | 'security_camera' | 'shield' | 'shield_check' | 'shield_crossed' | 'shield_lines' | 'shield_lines_circles' | 'spasibo' | 'speaker_waves' | 'square_on_square' | 'star_light' | 'student_hat' | 'telephone' | 'thermometer' | 'total' | 'trash' | 'tv_set' | 'umbrella' | 'user' | 'user_cross' | 'user_on_user' | 'vibration' | 'wallet' | 'watering_can' | 'waves' | 'waves_cross' | 'whistle' | 'wrench' | 'yule';
/**
 * Операционная система устройства.
 */
export declare type PlatformType = 'android' | 'ios' | 'web' | 'WEBDBG';
/**
 * Поверхность, от которой приходит вызов ассистента. Например, приложение СберБанк Онлайн или SberBox.
 */
export declare type Surface = string;
/**
 * Идентификатор персонажа, которого выбрал пользователь.
 */
export declare type CharacterId = 'sber' | 'athena' | 'joy';
/**
 * Имя персонажа.
 */
export declare type CharacterName = 'Сбер' | 'Афина' | 'Джой';
/**
...
export declare type PermissionType = 'geo' | 'read_contacts' | 'record_audio' | 'push';
export declare type PermissionStatus = 'granted' | 'denied_once' | 'denied_permanently';
/**
 * В этом поле клиент сообщает NLP какой персонаж выбран по дефолту
 */
export declare type DefaultCharacter = 'joy' | 'athena' | 'sber';
/**
 * Данные для анти-фрода, закодировааные в base64-строку.
 */
export declare type MobileSdkData = string;
/**
 * Результат работы антифрод-скрипта на мобильном устройстве.
 */
export declare type MobileSdkKav = string;
/**
 * Точка входа, через котороую зашли  в ассистента из хоста.
 */
export declare type HostAppState = string;
/**
 * Процент громкости.
 */
 ...
 */
export declare type StartAudioRecordingSource = string;
export declare type MediaCastStatus = 'enabled' | 'disabled';
/**
 ...
 */
export declare type SourceType = 'tray' | 'tabbarAppLaunchButton' | 'toolbarAppLaunchButton' | 'suggest' | 'card' | 'lavashar' | 'keyboard' | 'spotter' | 'autoListening' | 'shazam' | 'push' | 'deeplink' | 'repeatButton' | 'vps';
/**
 * Строка-содержание саджеста.
 */
export declare type SuggestTitle = string;
/**
 ...
 */
export declare type SaluteIdModel = string;
/**
 ...
 */
export declare type CensorClass = 'politicians' | 'obscene' | 'model_response';
/**
 * Список характеристик эмоциональной окраски текста пользователя.
 */
export declare type PhraseEmotions = 'negative' | 'positive' | 'neutral';
export declare type CompositeTokenName = 'MONEY_TOKEN' | 'PERSON_TOKEN' | 'TIME_DATE_TOKEN' | 'TIME_TIME_TOKEN' | 'PERIOD_TOKEN' | 'RELATIVE_TIME_TOKEN' | 'TIME_DATE_INTERVAL_TOKEN' | 'GEO_TOKEN' | 'ORG_TOKEN';
export declare type ListOfTokenTypesData = {
    token_type: string;
...
export declare type Action = TextAction | DeepLinkAction | SendContactPhone | ServerAction | CopyTextAction | OpenKeyboard | ShareTextAction | SmartappTextAction;
export declare type Card = ExtendedListCard | GalleryCard | GridCard | ListCard | QRCodeCard | DiscoveryCard | WidgetGalleryWithCategories | WidgetGallery | WidgetSingleCard | WidgetTitleCard | WidgetTwoColumns | WidgetNestedContentCard | WidgetButton | WidgetVerticalCards | SimpleList | OperatorCard;
/**
 * Карточка со списком ячеек и одной картинкой
 */
export declare type ExtendedListCard = CardBase & {
 ...
 */
export declare type Dimension = '0x' | '1x' | '2x' | '3x' | '4x' | '5x' | '6x' | '7x' | '8x' | '9x' | '10x' | '12x' | '16x';
export declare type SimpleCellView = TextCellView | ButtonCellView;
/**
 * Стиль текста, см https://www.figma.com/file/D0AfmXWT5KBPiWFNg2IZoF/SmartX-Typeface?node-id=0%3A1
 */
export declare type Typeface = 'display1' | 'display2' | 'display3' | 'headline1' | 'headline2' | 'headline3' | 'headline4' | 'headline5' | 'headline6' | 'title1' | 'title2' | 'body1' | 'body2' | 'body3' | 'body4' | 'body_ai' | 'text1' | 'paragraphText1' | 'paragraphText2' | 'footnote1' | 'footnote2' | 'footnote3' | 'button1' | 'button2' | 'caption' | 'underline';
/**
 * Цвет текста см https://www.figma.com/file/yaeE0lLDWMBKKLXuDHgq1p/SmartX-Styles?node-id=239%3A64
 */
export declare type TypeColor = 'default' | 'secondary' | 'tertiary' | 'inverse' | 'brand' | 'warning' | 'critical' | 'link';
/**
 ...
 */
export declare type PlasmsColor = 'textPrimary' | 'textSecondary' | 'textTertiary' | 'textParagraph' | 'textAccent' | 'textGradient' | 'textPositive' | 'textWarning' | 'textNegative' | 'onDarkTextPrimary' | 'onDarkTextSecondary' | 'onDarkTextTertiary' | 'onDarkTextParagraph' | 'onDarkTextAccent' | 'onDarkTextGradient' | 'onDarkTextPositive' | 'onDarkTextWarning' | 'onDarkTextNegative' | 'onLightTextPrimary' | 'onLightTextSecondary' | 'onLightTextTertiary' | 'onLightTextParagraph' | 'onLightTextAccent' | 'onLightTextGradient' | 'onLightTextPositive' | 'onLightTextWarning' | 'onLightTextNegative' | 'inverseTextPrimary' | 'inverseTextSecondary' | 'inverseTextTertiary' | 'inverseTextParagraph';
 ...
 */
export declare type RoundedCorners = 'none' | 'rounded' | 'circle';
/**
 ...
 */
export declare type ScaleMode = 'scale_aspect_fill' | 'scale_aspect_fit' | 'center' | 'top' | 'bottom';
/**
 * Цвет фона см https://www.figma.com/file/yaeE0lLDWMBKKLXuDHgq1p/SmartX-Styles?node-id=19%3A15
 */
export declare type Color = 'solid_black' | 'solid_white' | 'solid_transparent' | 'solid_disabled' | 'solid_brand' | 'solid_warning' | 'solid_critical' | 'solid_action' | 'secondary' | 'liquid_60' | 'liquid_50' | 'liquid_40' | 'liquid_30' | 'liquid_20' | 'liquid_10' | 'clear_transparent';
/**
...
export declare type ContentWidth = FixedContentWidth | MatchParent | Columns;
export declare type ContentHeight = FixedContentHeight | AspectRatio;
/**
 ...
 */
export declare type SurfaceColor = 'card' | 'transparent_primary' | 'transparent_secondary' | 'transparent_tertiary' | 'solid_primary' | 'solid_secondary' | 'solid_tertiary' | 'clear_transparent';
/**
 * Горизонтальная галерея
 */
export declare type GalleryCard = CardBase & {
    /**
     * @minItems 1
     */
...
export declare type GalleryItem = MediaGalleryItem | GallerySearchContentItem | GalleryMoreButtonItem;
/**
 ...
 */
export declare type IconSizeDimension = 'xsmall' | 'small' | 'medium' | 'large' | 'xlarge';
/**
 * Градиенты Plasma, см https://www.figma.com/file/ndmRHZxZo1bD8DuAnRsOtL/%F0%9F%8C%80Plasma-Mobile?node-id=6520%3A119
 */
export declare type Gradient = 'gradient_sber' | 'gradient_athena' | 'gradient_joy';
/**
 * Двумерная карточка (сетка)
 */
export declare type GridCard = CardBase & {
    /**
     * Количество ячеек
     */
    items: GridItem[];
...
export declare type GridItem = GreetingGridItem;
/**
 * Карточка с вертикальным списком ячеек.
 */
export declare type ListCard = CardBase & {
    cells: CellView[];
    type: 'list_card';
    actions?: Actions;
    /**
...
export declare type CellView = LeftRightCellView | HorizontalStackCellView | TextCellView | ButtonCellView | ImageCellView | DetailsCellView | WeatherCellView | RightSideCellView | FlexibleImageCellView | HorizontalCellsView | OperatorChatCellView;
export declare type LeftView = SimpleLeftView | FastAnswerLeftView | FlexibleImageLeftRightCellView | ImageTextsLeftCellView | PlasmaButtonCellView;
export declare type RightView = DisclosureRightView | DetailRightView | RoundButtonCellView | TagCellView | FlexibleImageLeftRightCellView | RightCellArrayView | PlasmaButtonCellView;
export declare type HorizontalCellContentView = VerticalIconTextView | SpacerView;
/**
 * https://www.figma.com/file/b5K8naZPDs3pE6pafBkoz8/%F0%9F%8C%80Plasma-Styles-Salute?node-id=5%3A213
 */
export declare type ButtonColor = 'primary_default' | 'secondary' | 'clear' | 'success' | 'warning' | 'critical' | 'checked' | 'global_black' | 'global_black_secondary' | 'global_black_transparent' | 'global_white' | 'global_white_secondary';
/**
 * Горизонтальный упорядоченный список карточек одной категории
 *
 * @minItems 1
 */
export declare type Items = [DiscoveryCard | ListCard, ...(DiscoveryCard | ListCard)[]];
/**
 * Встроенный блок с контентом
 */
export declare type NestedContent = NestedContentGallery | NestedContentList;
/**
 * Карточка с вертикальным списком ячеек.
 */
 ...
 */
export declare type ASRContextsId = string;
...
export interface SystemMessagePayload {
     ...
     */
    intent_meta?: number | string | boolean | {
        [k: string]: unknown;
    } | unknown[] | null;
    meta: Meta;
...
export interface Device {
     ...
     */
    additionalInfo: number | string | boolean | {
        [k: string]: unknown;
    } | unknown[] | null;
    [k: string]: unknown;
}
...
export interface AppState {
    item_selector?: number | string | boolean | {
        [k: string]: unknown;
    } | unknown[];
    [k: string]: unknown;
}
...
export interface AssistantCommand {
    command: SmartAppDataCommand | ActionCommand | CloseAppCommand | PermissionCommand | InvoiceCommand | SmartAppErrorCommand | OperatorCardCommand | RequestHashOfContactsCommand | RequestContactsCommand | RequestHashesCommand | RequestContactPhoneCommand;
    [k: string]: unknown;
}
/**
...
export interface HorizontalCellsView {
     ...
     * @maxItems 6
     */
    cells: [HorizontalCellContentView] | [HorizontalCellContentView, HorizontalCellContentView] | [HorizontalCellContentView, HorizontalCellContentView, HorizontalCellContentView] | [HorizontalCellContentView, HorizontalCellContentView, HorizontalCellContentView, HorizontalCellContentView] | [
...
//# sourceMappingURL=systemMessageOriginal.d.ts.map