 ...
 */
export declare type UserChannel = 'B2C' | 'SBOL' | 'COMPANION_B2C';
/**
 * Поверхность, от которой приходит вызов ассистента. Например, приложение СберБанк Онлайн или SberBox.
 */
export declare type Surface = 'SBERBOX' | 'SBERBOOM' | 'SBERBOOM_MINI' | 'SBERBOOM_R2' | 'COMPANION' | 'STARGATE' | 'SATELLITE' | 'TIME' | 'SBOL' | 'TV' | 'TV_HUAWEI';
/**
...
export declare type Meta = Omit<MetaOriginal, 'current_app' | 'background_apps'> & {
    current_app?: {
        app_info: AppInfo;
        state: AppState;
        [k: string]: unknown;
