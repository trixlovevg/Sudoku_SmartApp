...
export declare enum TaxSystemTypes {
    /** общая */
    obshii = 0,
    /** упрощенная, доход */
    uproshennui = 1,
...
export declare enum PaymentReponseStatuses {
...
export declare type PaymentInvoiceStatuses = 
/** заказ оплачен */
'confirmed'
...
export declare enum PayDialogStatuses {
    /** успешная оплата */
    success = 0,
    /** неожиданная ошибка */
    unexpectedError = 1,
