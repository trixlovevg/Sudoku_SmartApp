...
export interface ATUPayload extends SharedResponsePayload, Pick<SystemMessagePayload, 'auto_listening' | 'pronounceText' | 'pronounceTextType' | 'emotion' | 'suggestions' | 'asr_hints'> {
    intent?: string;
...
export interface PRAPayload extends SharedResponsePayload, Pick<SystemMessagePayload, 'pronounceText' | 'pronounceTextType'> {
    server_action: {
        app_info: {
            systemName: string;
        } | {
