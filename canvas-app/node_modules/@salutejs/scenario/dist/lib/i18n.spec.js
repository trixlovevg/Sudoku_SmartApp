...
describe('i18n', function () {
    ...
    describe('sber (default)', function () {
        it('should handle pluralization', function () {
            var adapterI18n = i18n_1.i18n()(keysetDict);
            expect(adapterI18n('{count} яблок у {number} студентов', { count: 0, number: 42 })).toEqual('нет яблок');
            expect(adapterI18n('{count} яблок у {number} студентов', { count: 1, number: 42 })).toEqual('1 яблоко у 42 студентов');
            expect(adapterI18n('{count} яблок у {number} студентов', { count: 3, number: 42 })).toEqual('3 яблока у 42 студентов');
            expect(adapterI18n('{count} яблок у {number} студентов', { count: 5, number: 42 })).toEqual('5 яблок у 42 студентов');
            expect(adapterI18n('{count} яблок у {number} студентов', { count: 22, number: 42 })).toEqual('22 яблока у 42 студентов');
            expect(adapterI18n('{count} яблок у {number} студентов', { count: 25, number: 42 })).toEqual('25 яблок у 42 студентов');
            expect(adapterI18n('{count} яблок у {number} студентов', { count: 1001, number: 42 })).toEqual('1001 яблоко у 42 студентов');
        });
        it('should get random phrase', function () {
            var adapterI18n = i18n_1.i18n()(keysetDict);
            var phrase = adapterI18n('Привет');
