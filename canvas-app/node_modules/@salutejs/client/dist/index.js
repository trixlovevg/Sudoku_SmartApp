...
var assistant = require('./assistant-7b035b22.js');
...
var createClient = function (configuration) {
    var metaProvider = function () { return assistant.__awaiter(void 0, void 0, void 0, function () {
        return assistant.__generator(this, function (_a) {
            return [2 /*return*/, Promise.resolve(assistant.convertFieldValuesToString({
                    theme: 'dark',
                    time: assistant.getTime(),
                    // eslint-disable-next-line camelcase
                    current_app: {
                        // eslint-disable-next-line camelcase
                        app_info: assistant.DEFAULT_APP,
                    },
                }))];
        });
    }); };
    var transport = assistant.createTransport({});
    var protocol = assistant.createProtocol(transport, assistant.__assign(assistant.__assign({}, configuration), { getInitialMeta: function () {
            return assistant.convertFieldValuesToString({
                default_character: 'sber',
            });
        } }));
    return assistant.createClient(protocol, metaProvider, {
        getVoiceMeta: function () { return ({}); },
    });
};
...
exports.createAudioRecorder = assistant.createAudioRecorder;
exports.createNavigatorAudioProvider = assistant.createNavigatorAudioProvider;
exports.createVoicePlayer = assistant.createVoicePlayer;
